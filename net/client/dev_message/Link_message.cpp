...
namespace hx_net
{
    ...
    {
        Vb vbl;
        map_Oid["1.3.6.1.4.1.8201.5.11.1.1.1.3.0"] = 0;
        vbl.set_oid(Oid("1.3.6.1.4.1.8201.5.11.1.1.1.3.0"));
        query_pdu += vbl;
        map_Oid["1.3.6.1.4.1.8201.5.11.1.1.1.4.0"] = 0;
        vbl.set_oid(Oid("1.3.6.1.4.1.8201.5.11.1.1.1.4.0"));
        query_pdu += vbl;
        map_Oid["1.3.6.1.4.1.8201.5.11.1.1.2.3.0"] = 0;
        vbl.set_oid(Oid("1.3.6.1.4.1.8201.5.11.1.1.2.3.0"));
        query_pdu += vbl;
        map_Oid["1.3.6.1.4.1.8201.5.11.1.1.2.4.0"] = 0;
        vbl.set_oid(Oid("1.3.6.1.4.1.8201.5.11.1.1.2.4.0"));
        query_pdu += vbl;
        map_Oid["1.3.6.1.4.1.8201.5.11.1.1.4.3.0"] = 0;
        vbl.set_oid(Oid("1.3.6.1.4.1.8201.5.11.1.1.4.3.0"));
        query_pdu += vbl;
    }
