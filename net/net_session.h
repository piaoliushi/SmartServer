...
{		
	...
	public:
		...
		tcp::socket& socket();
		udp::socket& usocket();//udpsocket
		tcp::endpoint get_addr();//{return socket().remote_endpoint();}
		...
		//切换音频通道
		//virtual bool switch_audio_channel(string sUser,int sNewChannel,e_ErrorCode &opResult){return false;};
